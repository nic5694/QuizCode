                            ...
                            .edgesIgnoringSafeArea(.all)
                                    ...
                                    VStack{
                                        ...
                                        ScrollView(.horizontal){
                                            VStack{
                                                HStack{
                                                    QuizContainerImageComponent(title: "HTML Quiz",image: Image("html"), themeColor: Color.red)
                                                    QuizContainerImageComponent(title: "Linux Quiz",image: Image("linux"),themeColor: Color.yellow)
                                                    QuizContainerImageComponent(title: "Docker Quiz",image: Image("docker"), themeColor: Color.gray)
                                                    QuizContainerImageComponent(title: "PHP Quiz", image: Image("php"), themeColor: Color.purple)
                                                    QuizContainerImageComponent(title: "Python Quiz", image: Image("python"), themeColor: Color.green)
                                                    QuizContainerImageComponent(title: "Javascript Quiz", image: Image("javascript"), themeColor: Color.orange)
                                                }
                                            }
                                        }
                                        Spacer()
